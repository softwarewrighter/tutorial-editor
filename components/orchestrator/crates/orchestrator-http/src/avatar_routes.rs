...
use orchestrator_http_handlers::{
    ...
    RemoveBackgroundRequest, StretchVideoRequest, handle_avatar_pipeline, handle_generate_audio,
    handle_generate_video, handle_lip_sync, handle_remove_background, handle_stretch_video,
};
use std::sync::Arc;
use warp::Filter;
